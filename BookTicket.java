...
public class BookTicket extends JFrame {
    ...
    public void bookTicket() {
        ...
        String date = ((String) jComboBox4.getSelectedItem()) + "-" + ((String) jComboBox3.getSelectedItem())
    ...
    private void initComponents() {
        ...
        jLabel15.setFont(new java.awt.Font("Nyala", 1, 24));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "___", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" }));

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 14));
        jLabel17.setText("/");

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "___", "2018", "2019" }));
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/railway/imgs/logo.jpg")));

        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/railway/imgs/logo.jpg"))); 

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/railway/imgs/rail-ticket-booking.jpg"))); 
